...
对于 RSS 情有独钟的同学可以下载免费应用 **RSS Prime** ，其中内置了一部分 RSS 源。如果网站中有<i class="fa fa-rss"></i> 就可以把对应的xml文件的url添加到订阅列表中，接受网站的推送。（不过鉴于国内优秀的 RSS 源太少了，仅有的都是有深度有稳定受众的，还是建议大家多添加国外的 RSS 源）我们已经在学辅的首页中也加入了 RSS 支持，**欢迎大家把学辅推送添加到你的 RSS 源中。**
